// Scraper for Los Medanos College
// Site: https://www.losmedanos.edu/
// Status: WORKING — extracts real courses
// Course list discovered: https://www.losmedanos.edu/schedule/index.aspx
// Platform guess: unknown
//
// Candidate links found while learning this site:
//   - "Class Schedule" -> https://www.losmedanos.edu/schedule/index.aspx
//
...
export const meta = {
  ...
  extractUrl: "https://www.losmedanos.edu/schedule/index.aspx",
  platform: "unknown",
  status: "working",
  candidates: [{"text":"Class Schedule","href":"https://www.losmedanos.edu/schedule/index.aspx","score":5}],
};
